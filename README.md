...
This repository is forked from [invopop/jsonschema](https://github.com/invopop/jsonschema).

- Optimize `Reflector.Reflect`
- `Schema` type cache (Draft, see following)
...
```console
go test -run='^$' -count=20 -bench -benchmem -benchtime=5x ./...
 ```
